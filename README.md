...
[<img alt="build status" src="https://img.shields.io/github/workflow/status/udoprog/fixed-vec-deque/CI/main?style=for-the-badge" height="20">](https://github.com/udoprog/fixed-vec-deque/actions?query=branch%3Amain)
